        ...
        <tbody>
          {data.map((row, i) => (
            <tr
              ...
              className={`border-b border-gray-100 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/50 text-gray-800 dark:text-gray-200 ${onRowClick ? 'cursor-pointer' : ''}`}
            >
              {columns.map((c) => (
