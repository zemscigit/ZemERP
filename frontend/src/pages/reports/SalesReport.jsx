...
import api from '../../api'
import { Card, Input, Money, PageHeader, Spinner, StatCard, Table, Button } from '../../components/ui'
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <StatCard label={`${t('total_amount')} (${t('sale')})`} value={<Money value={data.summary.total} />} color="text-green-600" />
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card title={t('top_products')} className="lg:col-span-2">
          <Table
            columns={[
              { key: 'code', label: t('code') },
              { key: 'name_th', label: t('product') },
