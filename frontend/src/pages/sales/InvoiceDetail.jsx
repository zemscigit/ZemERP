      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <Card title={t('document')} className="lg:col-span-2">
          <div className="grid grid-cols-2 gap-4 text-sm mb-4">
            ...
            <div><p className="text-gray-500 dark:text-gray-400">{t('due_date')}</p><p className="text-gray-700 dark:text-gray-300">{fmtDate(doc.due_date)}</p></div>
          ...
          {doc.payments?.length > 0 && (
            <div className="mt-6">
              <h4 className="font-semibold text-gray-700 dark:text-gray-300 mb-2">{t('payments')}</h4>
              <Table
                columns={[
